  ...
  if (recipientName) {
    const newUrl = `https://puade.github.io/unjhi-isco/?kepada=${recipientName}`;
...
function fetchUcapan() {
  var url = 'https://script.google.com/macros/s/AKfycbxpR7MghaUFed39OunzaBVF_clEWkLI3sHqgt9s3mkza43hCWg8bay_3hIPdid9Iq-TPg/exec'; // Ganti dengan URL Web App Google Apps Script Anda
...
document.getElementById('formPernikahan').addEventListener('submit', function(event) {
  ...
  fetch('https://script.google.com/macros/s/AKfycbxpR7MghaUFed39OunzaBVF_clEWkLI3sHqgt9s3mkza43hCWg8bay_3hIPdid9Iq-TPg/exec', {
    method: 'POST',
